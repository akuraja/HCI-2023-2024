  ...
  <section className="w-full mb-8 bg-white">
    <div className="container flex justify-between items-center gap-10">
      <div className="flex flex-col justify-start gap-5 max-w-xl mx-auto lg:m-0 text-black">
        <h1 className="font-bold font-serif text-4xl md:text-5xl lg:text-6xl mb-2 lg:mb-4"> {/* Povećana veličina slova */}
          UPOZNAJTE SPLIT &hearts; <br />
        </h1>
        <p className="font-roboto text-lg lg:text-xl"> {/* Povećana veličina slova */}
          Otkrijte nevjerojatnu kombinaciju bogate povijesti i impresivne arhitekture. Uživajte u prekrasnim plažama i jedinstvenom <br></br>spoju tradicije i modernog.
        </p>
      </div>
